<?php /* Smarty version Smarty-3.1.19, created on 2016-11-22 12:51:44
         compiled from "/Applications/MAMP/htdocs/staraddons/modules/paypal//views/templates/admin/back_office.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1748281357583431503fcbd8-63425360%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e94f51285b23344359f9e90cba619032cfe351fa' => 
    array (
      0 => '/Applications/MAMP/htdocs/staraddons/modules/paypal//views/templates/admin/back_office.tpl',
      1 => 1479815499,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1748281357583431503fcbd8-63425360',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58343150612ca1_70765741',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58343150612ca1_70765741')) {function content_58343150612ca1_70765741($_smarty_tpl) {?>
...
<div id="paypal-wrapper">
	...
	<div class="box half left">
		<?php if (isset($_smarty_tpl->tpl_vars['PayPal_logo']->value['LocalPayPalLogoLarge'])) {?>
			<img src="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_logo']->value['LocalPayPalLogoLarge'],'htmlall','UTF-8');?>
...
<a href="http://altfarm.mediaplex.com/ad/ck/3484-197941-8030-169"> <?php echo smartyTranslate(array('s'=>'Paypal Integration Guide','mod'=>'paypal'),$_smarty_tpl);?>
		...
		<form method="post" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_SERVER['REQUEST_URI'],'htmlall','UTF-8');?>
" id="paypal_configuration">
 ...
 :
							<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_country']->value,'htmlall','UTF-8');?>
...
?>
								<option value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['country']->value['id_country'],'htmlall','UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['country']->value['id_country']==$_smarty_tpl->tpl_vars['PayPal_country_id']->value) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['country']->value['name'],'htmlall','UTF-8');?>
</option>
							<?php } ?>
							</select>
...
</h4> <img src="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_logo']->value['BackOfficeCards'],'htmlall','UTF-8');?>
" height="22px"/>
					<div class="paypal-clear"></div>
					<div class="form-block">
						<?php if ((in_array($_smarty_tpl->tpl_vars['PayPal_WPS']->value,$_smarty_tpl->tpl_vars['PayPal_allowed_methods']->value))) {?>
							...
							<label for="paypal_payment_wps">
								<input type="radio" name="paypal_payment_method" id="paypal_payment_wps" value='<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_WPS']->value,'htmlall','UTF-8');?>
...
<br /><?php echo smartyTranslate(array('s'=>'No subscription fees, pay only when you get paid.','mod'=>'paypal'),$_smarty_tpl);?>
						...
						<?php if ((in_array($_smarty_tpl->tpl_vars['PayPal_HSS']->value,$_smarty_tpl->tpl_vars['PayPal_allowed_methods']->value))) {?>
							...
							<label for="paypal_payment_wpp">
								<input type="radio" name="paypal_payment_method" id="paypal_payment_wpp" value='<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_HSS']->value,'htmlall','UTF-8');?>
...
<br /><?php echo smartyTranslate(array('s'=>'Customized payments pages. Monthly subscription of 25€.','mod'=>'paypal'),$_smarty_tpl);?>
                        ...
                        <?php if ((in_array($_smarty_tpl->tpl_vars['PayPal_PPP']->value,$_smarty_tpl->tpl_vars['PayPal_allowed_methods']->value))) {?>
							...
							<label for="paypal_payment_ppp">
								<input type="radio" name="paypal_payment_method" id="paypal_payment_ppp" value='<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_PPP']->value,'htmlall','UTF-8');?>
...
</h4> <img src="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_logo']->value['LocalPayPalMarkSmall'],'htmlall','UTF-8');?>
" />
				<div class="form-block">
					
					<label for="paypal_payment_ecs">
						<input type="radio" name="paypal_payment_method" id="paypal_payment_ecs" value='<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_ECS']->value,'htmlall','UTF-8');?>
...
/views/img/logos/BRAINTREE.png" class="braintree_logo"> &nbsp;&nbsp;&nbsp;<div class="bo_paypal_help">?</div></a><br/>
                        <label for="braintree_enabled">
                            <input type="checkbox" name="braintree_enabled" id="braintree_enabled" value='<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_PVZ']->value,'htmlall','UTF-8');?>
...
<p class="toolbox"><?php echo smartyTranslate(array('s'=>'After clicking on the “Get my PayPal identification info” button, enter your login and password in the pop up, copy your PayPal identification info from the pop up and paste them is the below fields.','mod'=>'paypal'),$_smarty_tpl);?>
 ...
 : </label></dt>
							<dd><input type='text' name="api_username" id="api_username" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_api_username']->value,'html','UTF-8');?>
" autocomplete="off" size="85"/></dd>
 ...
 : </label></dt>
							<dd><input type='password' size="85" name="api_password" id="api_password" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_api_password']->value,'html','UTF-8');?>
" autocomplete="off" /></dd>
							<dt><label for="api_signature"><?php echo smartyTranslate(array('s'=>'API signature','mod'=>'paypal'),$_smarty_tpl);?>
 : </label></dt>
							<dd><input type='text' size="85" name="api_signature" id="api_signature" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_api_signature']->value,'html','UTF-8');?>
" autocomplete="off" /></dd>
						</dl>
						<div class="paypal-clear"></div>
 ...
 : </label></dt>
							<dd><input type='text' name="client_id" id="client_id" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_plus_client']->value,'html','UTF-8');?>
" autocomplete="off" size="85"/></dd>
							<dt><label for="secret"><?php echo smartyTranslate(array('s'=>'Secret','mod'=>'paypal'),$_smarty_tpl);?>
 : </label></dt>
							<dd><input type='password' size="85" name="secret" id="secret" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_plus_secret']->value,'html','UTF-8');?>
" autocomplete="off" /></dd>
 ...
 : </label></dt>
							<dd><input type='text' name="api_business_account" id="api_business_account" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_api_business_account']->value,'html','UTF-8');?>
" autocomplete="off" /></dd>
						</dl>
					</div>
 ...
 (recommanded)</label><br />
					...
					<div id="in_context_checkout" class="paypal-hide">
						...
						<p class="merchant_id">
							...
							<input type="text" name="in_context_checkout_merchant_id" id="in_context_checkout_merchant_id" value="<?php if (isset($_smarty_tpl->tpl_vars['PayPal_in_context_checkout_merchant_id']->value)&&$_smarty_tpl->tpl_vars['PayPal_in_context_checkout_merchant_id']->value!='') {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_in_context_checkout_merchant_id']->value,'htmlall','UTF-8');?>
<?php }?>" />
						</p>
					</div>
...
.<?php if ($_smarty_tpl->tpl_vars['default_lang_iso']->value=='fr') {?>(* <?php echo smartyTranslate(array('s'=>'See','mod'=>'paypal'),$_smarty_tpl);?>
 <a href="http://altfarm.mediaplex.com/ad/ck/3484-197941-8030-96"><?php echo smartyTranslate(array('s'=>'Integration Guide','mod'=>'paypal'),$_smarty_tpl);?>
							...
							<dl>
								...
								<dd>
									<input type="text" name="paypal_login_client_id" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_login_client_id']->value,'htmlall','UTF-8');?>
" autocomplete="off" size="85">
								...
								<dd>
									<input type="text" name="paypal_login_client_secret" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_login_secret']->value,'htmlall','UTF-8');?>
" autocomplete="off" size="85">
								</dd>
...
.pdf" class="bo_paypal_help">?</a></h3>
 ...
 : </label></dt>
							<dd><input type='text' name="braintree_public_key" id="braintree_public_key" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_braintree_public_key']->value,'html','UTF-8');?>
" autocomplete="off" size="85"/></dd>
							<dt><label for="braintree_private_key"><?php echo smartyTranslate(array('s'=>'Private Key','mod'=>'paypal'),$_smarty_tpl);?>
 : </label></dt>
							<dd><input type='password' size="85" name="braintree_private_key" id="braintree_private_key" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_braintree_private_key']->value,'html','UTF-8');?>
" autocomplete="off" /></dd>
							<dt><label for="braintree_merchant_id"><?php echo smartyTranslate(array('s'=>'Merchant ID','mod'=>'paypal'),$_smarty_tpl);?>
 : </label></dt>
							<dd><input type='text' size="85" name="braintree_merchant_id" id="braintree_merchant_id" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_braintree_merchant_id']->value,'html','UTF-8');?>
" autocomplete="off" /></dd>
						</dl>
						<div class="clear"></div>
						<span class="description"><?php echo smartyTranslate(array('s'=>'Please check once more that you pasted all the characters.','mod'=>'paypal'),$_smarty_tpl);?>
...
?>
								<dt><label for="account_braintree_<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['currency']->value['iso_code'],'html','UTF-8');?>
"><?php echo smartyTranslate(array('s'=>'Merchant accountID  in','mod'=>'paypal'),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['currency']->value['name'],'html','UTF-8');?>
 (<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['currency']->value['sign'],'html','UTF-8');?>
								...
								<dd><input type='text' name="account_braintree[<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['currency']->value['iso_code'],'html','UTF-8');?>
]" id="account_braintree_<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['currency']->value['iso_code'],'html','UTF-8');?>
" value="<?php if (isset($_smarty_tpl->tpl_vars['PayPal_account_braintree']->value[$_smarty_tpl->tpl_vars['currency']->value['iso_code']])) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['PayPal_account_braintree']->value[$_smarty_tpl->tpl_vars['currency']->value['iso_code']],'html','UTF-8');?>
