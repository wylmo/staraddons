...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'staraddons', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'serverVersion' => 5.0999999999999996447286321199499070644378662109375), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_56c1880f647c53760d6fb020c82049c6fc67aaf150b2a3beed487d56e90e25eb');
    ...
    {
        return $this->services['prestashop.core.admin.data_provider.addons_interface'] = new \PrestaShop\PrestaShop\Adapter\Addons\AddonsDataProvider($this->get('prestashop.addons.client_api'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('gq2MMW1LgmMmUSnoKunAtn19mCrvvFov6wrNHUhRNppBWR3wSoKG5YUB');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58340a470a7d70.23704852')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'gq2MMW1LgmMmUSnoKunAtn19mCrvvFov6wrNHUhRNppBWR3wSoKG5YUB',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2016-11-22',
            'locale' => 'fr-FR',
            'cookie_key' => 'LsoLs2ozUrro0z84xCo0fr614AimNXRTLs5DKZQVZBbppQvjjfAiCvIe',
            'cookie_iv' => 'Xt5x6KcP',
            'new_cookie_key' => 'def0000018d3f7d87ac6e64c2cea20d412684d819edd609005dd38ec31179e207769fa3076c981657cc878d73f46b47e73dca2d6e55acbf0384a18d389e941aca436ad53',
            ...
            'kernel.secret' => 'gq2MMW1LgmMmUSnoKunAtn19mCrvvFov6wrNHUhRNppBWR3wSoKG5YUB',
